...
BEGIN Scenario
    Name            STK_Fundementals

BEGIN Epoch

    Epoch        1 Nov 2017 16:00:00.000000000
    SmartEpoch
	BEGIN	EVENT
			Epoch	1 Nov 2017 16:00:00.000000000
			EventEpoch
...
Start                   1 Nov 2017 16:00:00.000000000
Stop                    2 Nov 2017 16:00:00.000000000
    SmartInterval
	BEGIN	EVENTINTERVAL
			BEGIN Interval
				Start	1 Nov 2017 16:00:00.000000000
...
BEGIN Animation
    ...
    StartTime          1 Nov 2017 16:00:00.000000000
    EndTime            2 Nov 2017 16:00:00.000000000
    CurrentTime        1 Nov 2017 16:00:00.000000000
    Direction          Forward
...
BEGIN MapData
    ...
    BEGIN Map
        ...
        BEGIN MapAttributes
            PrimaryBody          Earth
            SecondaryBody        Sun
            CenterLatitude       -7.744082
            CenterLongitude      -58.064489
...
BEGIN References
    ...
    Instance Aircraft/Aircraft1
        Aircraft/Aircraft1
    END Instance
    Instance Facility/Guam_2_GU2_Leolut
        Facility/Guam_2_GU2_Leolut
    END Instance
    Instance Missile/Missile3
        Missile/Missile3
    END Instance
    Instance Place/Waterloo
        Place/Waterloo
        Place/Waterloo/Sensor/Sensor1
    END Instance
    Instance Place/Waterloo/Sensor/Sensor1
        Place/Waterloo/Sensor/Sensor1
    END Instance
    Instance Satellite/ISS_ZARYA_25544
        Satellite/ISS_ZARYA_25544
    END Instance
    Instance Satellite/Scisat1_27858
        Satellite/Scisat1_27858
        Satellite/Scisat1_27858/Sensor/Sensor2
    END Instance
    Instance Satellite/Scisat1_27858/Sensor/Sensor2
        Satellite/Scisat1_27858/Sensor/Sensor2
    END Instance
END References
