...
BEGIN Scenario
    Name            When_Can_I_See_Santa

BEGIN Epoch

    Epoch        24 Dec 2017 23:00:00.000000000
    SmartEpoch
	BEGIN	EVENT
			Epoch	24 Dec 2017 23:00:00.000000000
			EventEpoch
...
Start                   24 Dec 2017 23:00:00.000000000
Stop                    25 Dec 2017 11:00:00.000000000
    SmartInterval
	BEGIN	EVENTINTERVAL
			StartEvent
				BEGIN	EVENT
...
BEGIN QuickReports
    ...
    BEGIN Report
        ...
        Style    Access
        AGIViewer    Yes
        Instance    Aircraft/Santa
        BEGIN InstanceList
            Instance    Place/PresentDelivery
        END InstanceList
        BEGIN TimeData
            BEGIN Section
                SectionNumber    1
        ...
        WindowRectLeft    950
        WindowRectTop     287
        WindowRectRight   1908
        WindowRectBottom  731
    END Report
END QuickReports
...
BEGIN Extensions
	...
	BEGIN	EVENTINTERVAL
			BEGIN Interval
				Start	14 Dec 2017 17:00:00.000000000
				Stop	15 Dec 2017 17:00:00.000000000
			END Interval
    ...
    End ShortText
    Begin LongText
When will Santa deliver my presents?
    End LongText
    END Desc
...
BEGIN Animation
    ...
    StartTime          24 Dec 2017 23:00:00.000000000
    EndTime            25 Dec 2017 11:00:00.000000000
    CurrentTime        25 Dec 2017 13:13:00.000000000
    Direction          Reverse
...
BEGIN MapData
    ...
    BEGIN Map
        ...
        BEGIN MapAttributes
            PrimaryBody          Earth
            SecondaryBody        Sun
            CenterLatitude       36.531238
            CenterLongitude      -92.365023
